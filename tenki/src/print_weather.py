...
def write_to_screen():
    ...
    font50 = ImageFont.truetype('Font.ttc', 50)
    font60 = ImageFont.truetype('Font.ttc', 60)
    font100 = ImageFont.truetype('Font.ttc', 100)
    font120 = ImageFont.truetype('Font.ttc', 120)
    font160 = ImageFont.truetype('Font.ttc', 160)
    ...
    print(f"{tommorow_datetime=}")
    print(f"{tommorow_week=}")
    print(f"{tommorow=}")

    icon_tomorow_image = Image.open(os.path.join(picdir, icon_mapping.half_icon[tommorow_telop]))
    print(f"ICON:{icon_mapping.half_icon[tommorow_telop]}")
